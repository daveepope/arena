...
| Platform | Produced by CI (`publish_testpypi` job in [build-test-publish-arena.yml](https://github.com/daveepope/arena/blob/master/.github/workflows/build-test-publish-arena.yml)) | Typical wheel tag |
|----------|---------------------------------------------------------------------------------------------|-------------------|
