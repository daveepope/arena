...
class LocalstackPlaybook:
    ...
    def __enter__(self) -> "LocalstackPlaybook":
        from arena_pytest._ffi import localstack_playbook_open
    ...
    def __exit__(self, exc_type, exc, tb) -> None:
        from arena_pytest._ffi import ArenaFfiError, localstack_playbook_close
    ...
    def close(self) -> None:
        if self._handle:
            from arena_pytest._ffi import localstack_playbook_close
