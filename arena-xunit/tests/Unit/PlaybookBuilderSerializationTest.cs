...
{
    [Fact]
    public void HttpPlaybook_BuildPostMapping_SerializesCorrectJson()
    {
    ...
    [Fact]
    public void HttpPlaybook_BuildGetMapping_SerializesCorrectJson()
    {
        var builder = new HttpPlaybookBuilder("dep-id")
            .Get("/health")
            .ExpectCalled(1);
    ...
    [Fact]
    public void HttpPlaybook_BuildWithResponse_SerializesStatus()
    {
        var builder = new HttpPlaybookBuilder("dep-id")
            .Post("/api/validate")
    ...
    [Fact]
    public void HttpPlaybook_BuildExpectCalled_SetsKindExactly()
    {
        var builder = new HttpPlaybookBuilder("dep-id")
            .Get("/check")
            .ExpectCalled(2);
    ...
    [Fact]
    public void HttpPlaybook_BuildExpectNeverCalled_SetsKindNever()
    {
        var builder = new HttpPlaybookBuilder("dep-id")
            .Get("/never")
            .ExpectNeverCalled();
