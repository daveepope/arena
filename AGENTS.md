...
- Prefer **sociable tests** and **lifecycle tests** that exercise real wiring (fixtures, extensions, hooks, arena open/close) over large numbers of tiny isolated tests with heavy mocking. Use narrow isolated tests for pure serialization, error branches, and other logic that does not need a running dependency.
