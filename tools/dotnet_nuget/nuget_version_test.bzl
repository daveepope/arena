...
def nuspec_file_test_suite(name):
    unittest.suite(
        name,
        partial.make(_nuget_package_version_noPrerelease_returnsVersion_test, size = "small"),
        partial.make(_nuget_package_version_withPrerelease_appendsSuffix_test, size = "small"),
        partial.make(_is_valid_prerelease_label_alphanumericHyphen_returnsTrue_test, size = "small"),
        partial.make(_is_valid_prerelease_label_withDot_returnsFalse_test, size = "small"),
        partial.make(_is_valid_prerelease_label_withUnderscore_returnsFalse_test, size = "small"),
        partial.make(_is_valid_prerelease_label_empty_returnsFalse_test, size = "small"),
    )
